...
const APIKEY = "pk.eyJ1Ijoic2hpdmFtMjAwM3N5IiwiYSI6ImNsa2RsdDF4YTA0Ymczcm5xOHA5NmsxZGMifQ.jTn_kCeufp7SzKiHyti4DQ";
...
const StoreLocation = () => {
  ...
  const [destinationCoords, setDestinationCoords] = useState([12.48839, 50.72724]);
  ...
  const renderItem = ({ item }) => (
    <TouchableOpacity
      ...
      <Icon
        name={item.icon}
        size={24}
        color={item.id == selectedRouteProfile ? 'white' : 'rgba(255,255,255,0.6)'}
      />
      <Text
        style={[
